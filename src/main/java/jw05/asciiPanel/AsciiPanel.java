...
//            System.out.println(AsciiPanel.class.getClassLoader().getResource("cp437.png"));
//            System.out.println(AsciiPanel.class.getClassLoader().getResource("src/main/resources/cp437.png"));
//            System.out.println(AsciiPanel.class.getClassLoader().getResource("AsciiFont.class"));
//            System.out.println(AsciiPanel.class.getClassLoader().getResource("mazegenerator/Main.class"));
//            System.out.println(new File(terminalFontFile));
//            File file = new File("src/main/resources/cp437.png");
